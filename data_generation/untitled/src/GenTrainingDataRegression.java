...
//public class GenTrainingDataRegression extends DataGenerator{
//
...
//            saveToTxtFile(new int[n_machines], workingTimeMatrix, bestNode.getValue(), "training_data_regression/" + workingTimeMatrix.length + "_" + n_machines + ".txt");
...
//                    break;
//                saveToTxtFile(bestNode.getState()[tasks], timeMatrix, bestNode.getValue(), "training_data/" + timeMatrix.length + "_" + n_machines + ".txt");
//            }
//        }
//    }
//}